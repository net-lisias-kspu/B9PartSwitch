...
* **`uiGroupName`** is the unique identifier of the group (only available for KSP 1.8 and newer).
* **`uiGroupDisplayName`** is the human readable name of the group to show in the UI (only available for KSP 1.8 and newer).
